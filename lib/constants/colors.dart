...
const MaterialColor custombackgroundcolorAccent =
    MaterialColor(_custombackgroundcolorAccentValue, <int, Color>{
  100: Color(0xFFECFFF9),
  200: Color(_custombackgroundcolorAccentValue),
  400: Color(0xFF86FFDA),
  700: Color(0xFF6DFFD2),
});
const int _custombackgroundcolorAccentValue = 0xFFECFFF9;
