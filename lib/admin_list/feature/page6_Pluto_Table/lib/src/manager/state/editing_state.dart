...
mixin EditingState implements IPlutoGridState {
  ...
  void changeCellValue(
    ...
    //index column value ='순서'
    // final dynamic field = refColumns.originalList[0].field;
    // final dynamic field = refRows.indexOf(currentRow);
    dynamic rowindex = refRows.indexOf(currentRow);
    dynamic columnindex = refColumns.indexOf(currentColumn);

    dynamic field = currentCell!.row;

    // final dynamic indexValue =
    //     rows[refRows.indexOf(currentRow)].cells['ID']!.value;
    // final dynamic lname =
    //     rows[refRows.indexOf(currentRow)].cells['라이센스']!.value;
    // final dynamic category =
    //     rows[refRows.indexOf(currentRow)].cells['업무구분']!.value;
    // final dynamic hostname =
    //     rows[refRows.indexOf(currentRow)].cells['HostName']!.value;
    // final dynamic ip = rows[refRows.indexOf(currentRow)].cells['IP']!.value;
    // final dynamic rank = rows[refRows.indexOf(currentRow)].cells['등급']!.value;
    // final dynamic cnt = rows[refRows.indexOf(currentRow)].cells['보유']!.value;
    // final dynamic pl = rows[refRows.indexOf(currentRow)].cells['PL']!.value;
    // final dynamic nuprac =
    //     rows[refRows.indexOf(currentRow)].cells['NUP RAC']!.value;
    // final dynamic nup = rows[refRows.indexOf(currentRow)].cells['NUP']!.value;
    // final dynamic rac = rows[refRows.indexOf(currentRow)].cells['RAC']!.value;
    // final dynamic version =
    //     rows[refRows.indexOf(currentRow)].cells['Version']!.value;
    // final dynamic exp_date =
    //     rows[refRows.indexOf(currentRow)].cells['만료일']!.value;
    // final dynamic index =
    //     rows[refRows.indexOf(currentRow)].cells['INDEX']!.value;
